      ...
      <card>
        <template slot="header">
          ...
          <p class="card-category">
            Created using <a href="https://www.google.com/fonts/specimen/Muli">Muli</a> Font Family
          </p>
        </template>
        <div class="content">
          <div class="typo-line">
          ...
          <div class="typo-line">
            <p>
              <span class="category">Paragraph</span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam
